...
for bit in [12, 24, 32, 48]:
    print(bit)
    database_hashes = np.load(f"/Users/kristiansjorslevnielsen/Documents/DVP7/DeepHashing/Pointwise/imagenet_tests/saved_hashes/database_{model}_{bit}.npy")
    ...
    query_hashes = np.load(f"/Users/kristiansjorslevnielsen/Documents/DVP7/DeepHashing/Pointwise/imagenet_tests/saved_hashes/query_{model}_{bit}.npy")
